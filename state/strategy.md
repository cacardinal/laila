...
> **This file is the source of truth for global priorities.** Domain files defer to it.
> When priorities conflict across domains, the ordering here wins. Update it in a
> deliberate session, not as a side effect of other work.
